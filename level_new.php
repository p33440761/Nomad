...
$photo2_sql = "SELECT * FROM products ORDER BY RAND() LIMIT 4";
$p_stmt2 = $pdo->query($photo2_sql);
$p2_rows = $p_stmt2->fetchAll();

$photo3_sql = "SELECT * FROM products ORDER BY RAND() LIMIT 4";
$p_stmt3 = $pdo->query($photo3_sql);
$p3_rows = $p_stmt3->fetchAll();

// $photo4_sql = "SELECT * FROM products_tony ORDER BY RAND() LIMIT 1";
// $p_stmt4 = $pdo->query($photo4_sql);
// $p4_rows = $p_stmt4->fetchAll();
...
<body>
        ...
        <div class="mobile_white">
            <div class="dropdown-box">
                <div class="dropdown d1 ">
                    ...
                    <ul>
                        <li><a href="#">全難度</a></li>
                        <?php foreach ($level_rows as $sl) : ?>
                        <li><a href="#"><?= $sl['level_name'] ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                ...
                <div class="dropdown d3">
                    ...
                    <ul>
                        ...
                        <?php foreach ($rows as $ml) : ?>
                        <li><a href="#"><?= $ml['main_mountain'] ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            ...
            <button class="btn btn-info">難度分級</button>
            <div class="landmark_all">
                <div class="north n_1 diffA areaN">司馬庫斯
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north n_2 diffB areaN">大霸尖山
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north n_3 diffA areaN">雪山
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north n_4 diffA areaN">加里山
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north n_5 diffA areaN">加羅湖
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north n_6 diffA areaN">雪見森林
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north m_1 diffB areaN">
                    <img src="./icomoon/svg/flag_red.svg">武陵四秀
                </div>
                <div class="north m_2 diffB areaM">
                    <img src="./icomoon/svg/flag_red.svg">白姑大山
                </div>
                <div class="north m_3 diffB areaM">大劍山
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north diffA m_4 areaM">志佳陽山
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north diffA m_5 areaM">忘憂森林
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north diffC m_6 areaM">
                    <img src="./icomoon/svg/flag_red.svg">甘薯山
                </div>
                <div class="north m_7 diffB areaM">
                    <img src="./icomoon/svg/flag_red.svg">合歡山
                </div>
                <div class="north m_8 diffA areaM">八通關山
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north m_9 diffA areaM ">玉山
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north m_10 diffA areaM">郡大山
                    <img src="./icomoon/svg/flag_red.svg">
                </div>
                <div class="north m_11 diffA areaM">
                    <img src="./icomoon/svg/flag_red.svg">畢錄山
                </div>
                <div class="north m_12 diffB areaM">
                    <img src="./icomoon/svg/flag_red.svg">水漾森林
                </div>
                <div class="north e_1 diffB areaE">
                    <img src="./icomoon/svg/flag_red.svg">南湖大山
                </div>
                <div class="north e_2 diffB areaE">
                    <img src="./icomoon/svg/flag_red.svg">屏風山
                </div>
                <div class="north e_3 diffB areaE">
                    <img src="./icomoon/svg/flag_red.svg">奇萊山
                </div>
                <div class="north e_4 diffA areaE">
                    <img src="./icomoon/svg/flag_red.svg">羊頭山
                </div>
                <div class="north e_5 diffA areaE">
                    <img src="./icomoon/svg/flag_red.svg">砂卡礑步道
                </div>
                <div class="north e_6 diffA areaE">
                    <img src="./icomoon/svg/flag_red.svg">奇萊南華
                </div>
                <div class="north e_7 diffC areaE">
                    <img src="./icomoon/svg/flag_red.svg">能高山
                </div>
                <div class="north e_8 diffC areaE">
                    <img src="./icomoon/svg/flag_red.svg">鈴鳴山
                </div>
                <div class="north e_9 diffA areaE">
                    <img src="./icomoon/svg/flag_red.svg">嘉明湖
                </div>
                <div class="north e_10 diffA areaE">
                    <img src="./icomoon/svg/flag_red.svg">瓦拉米古道
                </div>
                <div class="north s_8 diffA areaS">
                    <img src="./icomoon/svg/flag_red.svg">北大武山
                </div>
                <div class="east"></div>
                <div class="middle"></div>
                <div class="south"></div>
            </div>
            <div class="level_page_flexbox">
                ...
                <div class="mountain_box">
                    ...
                    <div class="mountain_info">
                        <div class="mountain_name">
                            ...
                            <div class="other_mountain">
                                <div class="other_mountain_1 active"><span id="other_mountain_1">主峰</span></div>
                                <div class="other_mountain_2"><span id="other_mountain_2">東峰</span></div>
                                <div class="other_mountain_3"><span id="other_mountain_3">北峰</span></div>
                            </div>
                        </div>
                        <div class="card1">
                            <div class="m_img_container">
                                <img id="img1_mountain" src="./images/B0008/B0008_2.jpeg">
                            </div>
                            <div id="info1" class="mountain_info_text">
                                玉山國家公園以玉山為名，此山系因歐亞、菲律賓板塊相擠撞而高隆，主稜脈略呈十字形，十字交點即為標高3,952公尺的主峰；園內超過3,000公尺且名列「臺灣百岳」的高山有30座，其中玉山東峰為陡立險峻的十峻之首、秀姑巒山是中央山脈第一高峰、關山是南臺首嶽、新康山為東臺一霸，這一座座高山就像眾星拱月般，將玉山圍繞襯托，也呈現山岳型國家公園的氣勢。
                            </div>
                            <div class="info_border"><br></div>
                            <div class="high_level_location">
                                <div class="box">
                                    <p>高度</p>
                                    <p id="high_1">3952m</p>
                                </div>
                                ...
                                <div class="box">
                                    <p>所在位置</p>
                                    <p id="detail_area">台灣-南投</p>
                                </div>
                            </div>
                            <button class="btn btn-primary">建議裝備</button>
                            <div class="equ_img_four">
                                <div class="equ_img_two">
                                    <div class="equ_img 1 ">
                                        <a id="a1" href="product-detail.php?sid=5">
                                            <img id="eq1" src="big-photo/PA005.jpg"></a>
                                    </div>
                                    <div class="equ_img 2">
                                        <a id="a2" href="product-detail.php?sid=21">
                                            <img id="eq2" src="big-photo/PB006.jpg"></a>
                                    </div>
                                </div>
                                <div class="equ_img_two">
                                    <div class="equ_img 3">
                                        <a id="a3" href="product-detail.php?sid=59">
                                            <img id="eq3" src="big-photo/PD014.jpg"></a>
                                    </div>
                                    <div class="equ_img 4">
                                        <a id="a4" href="product-detail.php?sid=100">
                                            <img id="eq4" src="big-photo/PF013.jpg"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card2">
                            <div class="m_img_container img2">
                                <img id="img2_mountain" src="./images/B0008/B0008_3.jpeg">
                            </div>
                            <div id="info2" class="mountain_info_text info2 ">
                                玉山東峰標高3869公尺，日治時期名為東山、新高東山、台東新高，山體岩壁崢嶸，巍峨險要，台灣登山家刑天正稱其為天壘峰，為台灣玉山山脈中的一座高山，為台灣百岳排名第三的高峰，也是台灣百岳名峰中的「十峻」之首，位於玉山主峰東側，歸屬玉山國家公園境內。
                            </div>
                            <div class="info_border"><br></div>
                            <div class="high_level_location">
                                <div class="box">
                            ...
                            <div class="equ_img_four">
                                <div class="equ_img_two">
                                    <?php foreach ($p2_rows as $p2) : ?>
                                    <div class="equ_img 1 ">
                                        <a href="http://localhost/nomad/product-detail.php?sid=<?= $p2['sid'] ?>">
                                            <img src="big-photo/<?= $p2['product_id'] ?>.jpg">
                                        </a>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                        ...
                        <div class="card3">
                            <div class="m_img_container ">
                                <img id="img3_mountain" src="./images/B0008/B0008_5.jpeg">
                            </div>
                            <div id="info3" class="mountain_info_text info3">
                                海拔3,858M，百岳排行#003，乃台灣八秀之首。日據時期名為北山、新高北山、斗六新高，與玉山北北峰相隔一鞍，狀似駱駝的駝峰，因而登山界的四大天王刑天正稱其為天駝峰。北峰山麓設置有氣象觀測站，是台灣海拔最高的氣象站，也是台灣海拔最高的政府機構。北峰登山口位於主峰之下，兩者相距僅200公尺，大多數的人都會選擇主、北峰一次爬完。
                            </div>
                            <div class="info_border"><br></div>
                            <div class="high_level_location">
                                <div class="box">
                            ...
                            <div class="equ_img_four">
                                <div class="equ_img_two">
                                    <?php foreach ($p3_rows as $p3) : ?>
                                    <div class="equ_img 1 ">
                                        <a href="http://localhost/nomad/product-detail.php?sid=<?= $p3['sid'] ?>">
                                            <img src="big-photo/<?= $p3['product_id'] ?>.jpg">
                                        </a>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                ...
                <div class="level_light_box">
                    ...
                    <div class="info-text">
                        ...
                        <P><span>A 級：</span>一般健行路線，活動天數約需 1-3 天。</P>
                        <P><span>B 級：</span>中級縱走路線，活動天數約需 4-5 天或活動天數約需 1-3 天但有危險地形。</P>
                        <P><span>C 級：</span>高級縱走路線，活動天數約需 5 天以上。</P>
                        <P><span>C+級：</span>高級縱走路線，有垂降及攀岩地形。</P>
                        <p class="level-line"></p>
                        <p class="season_title">雪季期間</p>
                        <P><span>D 級：</span>雪地健行及縱走，雪季管制期間有條件開放之路線。</P>
                        <P><span>E 級：</span>雪季管制期間暫停開放之路線。</P>
                    </div>
    ...
    <?php include __DIR__ . '/parts-php/html-scripts_footer_level.php'; ?>
