...
<body>
    ...
    <div class="mobile_white hero-section">
        ...
        <div class="weather_page">
            <div class="landmark_all">
                <div class="north north_n n_1 hsinchu_country_location">司馬庫斯
                    <img src="./icomoon/svg/location.svg">
                </div>
                <div class="north north_n n_2 hsinchu_country_location">大霸尖山
                    <img src="./icomoon/svg/location.svg">
                </div>
                <div class="north north_n n_3 miaoli_country_location">雪山
                    <img src="./icomoon/svg/location.svg">
                </div>
                <div class="north north_n n_4 miaoli_country_location">加里山
                    <img src="./icomoon/svg/location.svg">
                </div>
                <div class="north north_n n_5 yilan_country_location">加羅湖
                    <img src="./icomoon/svg/location.svg">
                </div>
                <div class="north north_n n_6 miaoli_country_location">雪見森林
                    <img src="./icomoon/svg/location.svg">
                </div>
                <div class="east">
                    <div class="north north_e e_1 hualien_country_location">
                        <img src="./icomoon/svg/location.svg">南湖大山
                    </div>
                    <div class="north north_e e_2 hualien_country_location">
                        <img src="./icomoon/svg/location.svg">屏風山
                    </div>
                    <div class="north north_e e_3 hualien_country_location">
                        <img src="./icomoon/svg/location.svg">奇萊山
                    </div>
                    <div class="north north_e e_4 hualien_country_location">
                        <img src="./icomoon/svg/location.svg">羊頭山
                    </div>
                    <div class="north north_e e_5 hualien_country_location">
                        <img src="./icomoon/svg/location.svg">砂卡礑步道
                    </div>
                    <div class="north north_e e_6 hualien_country_location">
                        <img src="./icomoon/svg/location.svg">奇萊南華
                    </div>
                    <div class="north north_e e_7 hualien_country_location">
                        <img src="./icomoon/svg/location.svg">能高山
                    </div>
                    <div class="north north_e e_8 hualien_country_location">
                        <img src="./icomoon/svg/location.svg">鈴鳴山
                    </div>
                    <div class="north north_e e_9 taitung_country_location">
                        <img src="./icomoon/svg/location.svg">嘉明湖
                    </div>
                    <div class="north north_e e_10 taitung_country_location">
                        <img src="./icomoon/svg/location.svg">瓦拉米古道
                    </div>
                    <div class="north s_8 pingtung_country_location">
                        <img src="./icomoon/svg/location.svg">北大武山
                    </div>
                </div>
                <div class="middle">
                    <div class="north north_m m_1 taichung_city_location">
                        <img src="./icomoon/svg/location.svg">武陵四秀
                    </div>
                    <div class="north north_m m_2 taichung_city_location">
                        <img src="./icomoon/svg/location.svg">白姑大山
                    </div>
                    <div class="north north_m m_3 taichung_city_location">大劍山
                        <img src="./icomoon/svg/location.svg">
                    </div>
                    <div class="north north_m m_4 taichung_city_location">志佳陽山
                        <img src="./icomoon/svg/location.svg">
                    </div>
                    <div class="north north_m m_5 taichung_city_location">忘憂森林
                        <img src="./icomoon/svg/location.svg">
                    </div>
                    <div class="north north_m m_6 taichung_city_location">
                        <img src="./icomoon/svg/location.svg">甘薯山
                    </div>
                    <div class="north north_m m_7 nantou_country_location">
                        <img src="./icomoon/svg/location.svg">合歡山
                    </div>
                    <div class="north north_m m_8 nantou_country_location">八通關山
                        <img src="./icomoon/svg/location.svg">
                    </div>
                    <div class="north north_m m_9 nantou_country_location">玉山
                        <img src="./icomoon/svg/location.svg">
                    </div>
                    <div class="north north_m m_10 nantou_country_location">郡大山
                        <img src="./icomoon/svg/location.svg">
                    </div>
                    <div class="north north_m m_11 nantou_country_location">
                        <img src="./icomoon/svg/location.svg">畢錄山
                    </div>
                    <div class="north north_m m_12 chiayi_country_location">
                        <img src="./icomoon/svg/location.svg">水漾森林
                    </div>
            ...
            <form class="form_mountain">
                <input class="chosen-value" type="text" value="" placeholder="search">
                <ul class="value-list">
                    <?php foreach ($rows2 as $m) : ?>
                    <li><?= $m['mountain_name'] ?></li>
                    <?php endforeach; ?>
                </ul>
            </form>
            ...
            <svg id="cf503461-00bd-459a-aeb5-062ebc913211" data-name="圖層 1" xmlns="http://www.w3.org/2000/svg"
                ...
                <path id="2b6aac2d-ce2d-4c48-89d5-ff2a81000e07" data-name="chiayi_country"
                    class="chiayi_country 96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                ...
                <path id="30e45b59-571b-4340-a006-0ba62460619a" data-name="taichung_city"
                    class=" taichung_city 96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 "
                ...
                <path id="21c4ba33-d057-42c1-9c71-be6061fc73cf pingtung_country" data-name="pingtung_country"
                    class=" pingtung_country 96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                ...
                <path id="f8107e5f-0c12-4631-aed9-d525f4e8558d" data-name="yilan_country"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 yilan_country"
                ...
                <path id="350fa9bc-d25e-4c61-ae4b-b5c60b1a74b6" data-name="hsinchu_city"
                    class="hsinchu_city 96fdfe13-4732-40bb-9e9c-cdc6e310fcb9  "
                ...
                <path id="ea41be52-3728-49f2-aa36-b90633ee55f6" data-name="hsinchu_country"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 hsinchu_country"
                ...
                <path id="ffd01e75-6ce2-4cfa-af98-bc61479c68ed" data-name="miaoli_country"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 miaoli_country "
                ...
                <path id="e468a7aa-2bdf-4501-b48d-35483b7c8ccc" data-name="hualien_country"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 hualien_country"
                ...
                <path id="7ed22330-8901-4fc6-a351-206f6b2daf2b" data-name="nantou_country"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 nantou_country"
                ...
                <path id="ae9239f1-7686-4c40-a5f8-f322391c7328" data-name="taitung_country"
                    class="taitung_country 96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 "
            ...
            <div class="weather_box">
                ...
                <div class="mountain_weather">
                    <?php foreach ($rows as $r) : ?>
                    <div class="mountain_name ff-noto"><span id="mountain_name"><?= $r['mountain_name'] ?></span>
                        <br><span class="mountain_date"><?php echo date("Y-m-d"); ?></span>
                        <div class="icon_tem">
                            <div class="icon_tem_img"><img src="./icomoon/svg/sun.svg"></div>
                            <span id="tem" class="tem ff-noto"><?= $r['tem'] ?>℃</span>
                        </div>
                    ...
                    <div class="detailed_weather">
                        ...
                        <div class="wind-rain ff-noto">
                            <span id="wind"><?= $r['wind'] ?>mph</span>
                            <br>風速<br><br>
                            <span id="rain"><?= $r['rain'] ?></span>
                            %<br>降雨機率
                        </div>
                        <div class="rise-set ff-noto">
                            <span id="sunrise"><?= $r['sunrise'] ?></span>
                            <br>日出<br><br>
                            <span id="sunset"><?= $r['sunset'] ?></span><br>日落
                        </div>
                    </div>
                    <?php endforeach; ?>
                    <p class="line"></p>
                ...
                <div class="todays_weather">
                    <p class="today_title">今日天氣</p>
                    <div id="today_time_box">
                        <div class="time_weather first">
                            <div class="small_center">
                                <p>3am</p>
                                <div class="weather_icon_container">
                                    <img id="three_am_icon" src="./icomoon/svg/sun.svg"">
                        </div>
                        <p id=" three_am_tem">21℃</p>
                                </div>
                            </div>
                            <div class="time_weather">
                                <div class="small_center">
                                    <p>6am</p>
                                    <div class="weather_icon_container">
                                        <img id="six_am_icon" src="./icomoon/svg/rain.svg">
                                    </div>
                                    <p id="six_am_tem">23℃</p>
                                </div>
                            </div>
                            <div class="time_weather">
                                <div class="small_center">
                                    <p>9am</p>
                                    <div class="weather_icon_container">
                                        <img id="nine_am_icon" src="./icomoon/svg/rain.svg">
                                    </div>
                                    <p id="nine_am_tem">26℃</p>
                                </div>
                            </div>
                            <div class="time_weather">
                                <div class="small_center">
                                    <p>12pm</p>
                                    <div class="weather_icon_container">
                                        <img id="twelve_pm_icon" src="./icomoon/svg/cloudy.svg">
                                    </div>
                                    <p id="twelve_pm_tem">30℃</p>
                                </div>
                            </div>
                            <div class="time_weather">
                                <div class="small_center">
                                    <p>3pm</p>
                                    <div class="weather_icon_container">
                                        <img id="three_pm_icon" src="./icomoon/svg/cloudy.svg">
                                    </div>
                                    <p id="three_pm_tem">23℃</p>
                                </div>
                            </div>
                            <div class="time_weather">
                                <div class="small_center">
                                    <p>6pm</p>
                                    <div class="weather_icon_container">
                                        <img id="six_pm_icon" src="./icomoon/svg/cloudy.svg">
                                    </div>
                                    <p id="six_pm_tem">23℃</p>
                                </div>
                            </div>

                        </div>
                    </div>
                    <div class="next_5_days">
                        <p class="next_title ff-noto">未來一周預報</p>
                        <div id="week_mobile">
                        ...
                        <div class="week_container">
                            ...
                            <div class="low"><span id="nextd1_low">12℃</span><br>最低溫</div>
                            <div class="high"><span id="nextd1_high">18℃</span><br>最高溫</div>
                            <div class="wind"><span id="nextd1_wind">4mph</span><br>風速</div>
                            <div class="rain"><span id="nextd1_rain">40%</span><br>降雨機率</div>
                        </div>
                        <div class="week_container">
                            <div class="week_date">
                                <p>星期六<br>5/29</p>
                            ...
                            <div class="low"><span id="nextd2_low">15℃</span><br>最低溫</div>
                            <div class="high"><span id="nextd2_high">19℃</span><br>最高溫</div>
                            <div class="wind"><span id="nextd2_wind">7mph</span><br>風速</div>
                            <div class="rain"><span id="nextd2_rain">40%</span><br>降雨機率</div>
                        </div>
                        <div class="week_container">
                            <div class="week_date">
                                <p>星期日<br>5/30</p>
                            ...
                            <div class="low"><span id="nextd3_low">13℃</span><br>最低溫</div>
                            <div class="high"><span id="nextd3_high">20℃</span><br>最高溫</div>
                            <div class="wind"><span id="nextd3_wind">2mph</span><br>風速</div>
                            <div class="rain"><span id="nextd3_rain">10%</span><br>降雨機率</div>
                        </div>
                        <div class="week_container">
                            <div class="week_date">
                                <p>星期一<br>5/31</p>
                            ...
                            <div class="low"><span id="nextd4_low">14℃</span><br>最低溫</div>
                            <div class="high"><span id="nextd4_high">21℃</span><br>最高溫</div>
                            <div class="wind"><span id="nextd4_wind">5mph</span><br>風速</div>
                            <div class="rain"><span id="nextd4_rain">10%</span><br>降雨機率</div>
                        </div>
                        <div class="week_container">
                            <div class="week_date">
                                <p>星期二<br>6/1</p>
                            ...
                            <div class="low"><span id="nextd5_low">14℃</span><br>最低溫</div>
                            <div class="high"><span id="nextd5_high">22℃</span><br>最高溫</div>
                            <div class="wind"><span id="nextd5_wind">4mph</span><br>風速</div>
                            <div class="rain"><span id="nextd5_rain">0%</span><br>降雨機率</div>
                        </div>
        ...
        <?php include __DIR__ . '/parts-php/html-scripts_footer_weather.php'; ?>
